...
func (in *CELPayload) DeepCopyInto(out *CELPayload) {
	*out = *in
	if in.Inputs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CELPayload.
func (in *CELPayload) DeepCopy() *CELPayload {
	if in == nil {
		return nil
	}
	out := new(CELPayload)
...
func (in *CustomRule) DeepCopyInto(out *CustomRule) {
	*out = *in
	...
	in.CELPayload.DeepCopyInto(&out.CELPayload)
}
